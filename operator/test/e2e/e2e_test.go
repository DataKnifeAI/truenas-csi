...
import (
	...
	"github.com/truenas/truenas-csi/operator/test/utils"
)
...
var _ = Describe("Manager", Ordered, func() {
	...
	BeforeAll(func() {
		...
		By("labeling the namespace to allow metrics access through NetworkPolicy")
		cmd = exec.Command("kubectl", "label", "--overwrite", "ns", namespace,
			"metrics=enabled")
		_, err = utils.Run(cmd)
		Expect(err).NotTo(HaveOccurred(), "Failed to label namespace for metrics access")
